namespace EcoAnalyzer
{
    partial class EcoAnalyzerGraphPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            btn_Back.Location = new Point(658, 23);
            ...
            tbl_PlotMain.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 70F));
            tbl_PlotMain.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 30F));
            ...
            tbl_PlotMain.Size = new Size(993, 440);
            ...
            tbl_LegendButtons.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 15F));
            tbl_LegendButtons.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 85F));
            tbl_LegendButtons.Location = new Point(3, 37);
            ...
            tbl_LegendButtons.RowStyles.Add(new RowStyle(SizeType.Absolute, 20F));
            tbl_LegendButtons.RowStyles.Add(new RowStyle(SizeType.Absolute, 20F));
            tbl_LegendButtons.RowStyles.Add(new RowStyle(SizeType.Absolute, 20F));
            tbl_LegendButtons.RowStyles.Add(new RowStyle(SizeType.Absolute, 20F));
            tbl_LegendButtons.RowStyles.Add(new RowStyle(SizeType.Absolute, 20F));
            tbl_LegendButtons.RowStyles.Add(new RowStyle(SizeType.Absolute, 20F));
            tbl_LegendButtons.Size = new Size(286, 394);
